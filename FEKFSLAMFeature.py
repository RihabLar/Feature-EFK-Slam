...
class FEKFSLAMFeature(MapFeature):
    ...
    def hfj(self, xk_bar, Fj):  # Observation function for zf_i and x_Fj
        ...
        #return ...
        #_ compute the expected observation of the feature Fj based on current robot pose xk_bar and the stored psoition of the feature in the state vector
    ...
    def Jhfjx(self, xk, Fj):  # Observation function for zf_i and x_Fj
        ...
        # It represents how small changes in the state vector xk affect the predicted observation of a specific feature F j
        ...
        J[:2, :3] = J1 @ J2 @ J3  # first two rows, first three colums
        J[:2, start_index:start_index + self.xF_dim] = J1 @ J4   # first two rows, feature columnc
        return J
